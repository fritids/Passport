...
Version: 1.0
Author URI: http://www.wordimpressed.com/
Plugin URI: http://www.wordimpressed.com/
Description:  This plugin allows total control over your WordPress admin icons.  Implement your own custom WordPress icons for the WordPress admin dashboard through an easy-to-use and intuitive GUI interface.  Developed by Devin Walker of <a href="http://www.wordimpressed.com">WordImpressed</a> for the WordPress community.
Author: Devin Walker
License: GPL2

	USAGE:

	Copyright (C) 2010  Devin Walker, http://www.wordimpressed.com
...
/* Version check */
  ...
  $exit_msg=' WP Admin Icons requires WordPress 2.5 or newer.  <a href="http://codex.wordpress.org/Upgrading_WordPress">Please update!</a>';
...
if ($file == $this_plugin){
$settings_link = '<a href="'.$sitename.'/wp-admin/options-general.php?page=wp-admin-icons.php/wp-admin-icons-init.php">'.__("Settings", "photosmash-galleries").'</a>';
...
$moreOptions = get_option('admin-icons-options-more');
	...
	echo '<style type="text/css" media="screen" class="admin-icons">';
				...
				echo '#adminmenu .menu-icon-dashboard div.wp-menu-image {
					background:url("';  echo $options["dashboardIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-dashboard.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-dashboard.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["dashboardIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu #menu-posts div.wp-menu-image {
					background:url("';  echo $options["postIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu #menu-posts.wp-menu-open  div.wp-menu-image, #adminmenu #menu-posts.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["postIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo  '#adminmenu .menu-icon-media div.wp-menu-image {
					background:url("';  echo $options["mediaIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-media.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-media.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["mediaIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-links div.wp-menu-image {
					background:url("';  echo $options["linksIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-links.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-media.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["linksIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-page div.wp-menu-image {
					background:url("';  echo $options["pagesIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-page.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-page.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["pagesIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-comments div.wp-menu-image {
					background:url("';  echo $options["commentsIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-comments.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-comments.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["commentsIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-appearance div.wp-menu-image {
					background:url("';  echo $options["appearanceIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-appearance.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-appearance.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["appearanceIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-plugins div.wp-menu-image {
					background:url("';  echo $options["pluginsIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-plugins.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-plugins.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["pluginsIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-users div.wp-menu-image {
					background:url("';  echo $options["usersIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-users.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-users.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["usersIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-tools div.wp-menu-image {
					background:url("';  echo $options["toolsIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-tools.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-tools.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["toolsIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				echo '#adminmenu .menu-icon-settings div.wp-menu-image {
					background:url("';  echo $options["settingsIconURL"]; echo '") no-repeat scroll 7px -17px transparent;
				}
				#adminmenu .menu-icon-settings.wp-menu-open  div.wp-menu-image, #adminmenu .menu-icon-settings.wp-menu-open:hover  div.wp-menu-image  {
					background:url("';  echo $options["settingsIconURL"]; echo '") no-repeat scroll 7px 7px transparent;
				}
				...
				$post_types=get_post_types($args,'names');
					...
					foreach ($post_types as $post_type ) {
							...
							$thisOption = $postTypeName[0].'IconURL';
					...
					background:url("';  
				 			...
				 			echo $options[$thisOption];	
				 
							echo '") no-repeat scroll 7px -17px transparent; background-position-y:-17px !important }';
					
								
							echo '#adminmenu #menu-posts-'.$post_type.':hover  div.wp-menu-image  { background:url("';  
							
							echo $options[$thisOption];
							
							echo '") no-repeat scroll 7px 7px transparent; background-position-y:7px !important }';
							
							
							echo '#adminmenu #menu-posts-'.$post_type.'.wp-menu-open  div.wp-menu-image { background:url("';  
